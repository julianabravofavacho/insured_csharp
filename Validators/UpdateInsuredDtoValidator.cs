...
{
    public class UpdateInsuredDtoValidator : AbstractValidator<UpdateInsuredDto>
    {
        public UpdateInsuredDtoValidator()
        {
            RuleFor(x => x.id)
                .GreaterThan(0).WithMessage("Id do segurado é obrigatório.");
